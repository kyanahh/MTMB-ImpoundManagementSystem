...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertQuery = "INSERT INTO vehicles (userid, platenumber, vehicle_type, model, color, registration_date, chassis_number, 
        engine_number) VALUES ('$userid', '$platenumber', '$vehicle_type', '$model', 
    ...
    if (!$result) {
        ...
        $platenumber = $vehicle_type = $model = $color = $registration_date = $chassis_number = $engine_number = "";
