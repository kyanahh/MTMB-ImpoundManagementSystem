...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($emailExistsResult->num_rows > 0) {
        ...
        $firstname = $lastname = $phone = $gender = $email = $password = $bday =  $usertype = $homeaddress = "";
    } else {
            ...
            <div class="px-3 pt-4">
                <form method="POST" action="<?php htmlspecialchars("SELF_PHP"); ?>">
                    ...
                    <div class="row mb-3 mt-2">
                        ...
                        <div class="col-sm-4">
                            <input type="date" class="form-control" id="bday" name="bday" value="<?php echo $bday; ?>">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="row mb-3 mt-2">
                        <div class="col-sm-2">
                            <label class="form-label mt-2 px-3">Password</label>
                        </div>
                        <div class="col-sm-4">
                            <input type="password" class="form-control" name="password" id="password" value="<?php echo $password; ?>" placeholder="Enter password">
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-4">
                            <select id="usertype" name="usertype" class="form-select" required>
                                ...
                                <option value="Vehicle Owner" <?php echo ($usertype === "Vehicle Owner") ? "selected" : ""; ?>>Vehicle Owner</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 mt-2">
                        <div class="col-sm-2">
                            <label class="form-label mt-2 px-3">Home Address</label>
                        </div>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="homeaddress" id="homeaddress" value="<?php echo $homeaddress; ?>" placeholder="Enter home address">
                        </div>
                    </div>
