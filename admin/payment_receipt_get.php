...
if (isset($_POST['paymentid'])) {
    ...
    $stmt = $connection->prepare("SELECT payments.paymentid, fines.fineid, fines.total_amount, payments.amount_paid, 
        (payments.amount_paid - fines.total_amount) AS change_amount, payments.date_paid, payments.payment_method, 
