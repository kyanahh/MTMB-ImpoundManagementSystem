...
<body>
    ...
    <div class="main-container d-flex">
        ...
        <div class="content bg-light">
            ...
            <!-- List of Vehicle Violations  -->
            <div class="px-3">
                <div class="row">
                    <div class="col-sm-2">
                        <h2 class="fs-5 mt-1 ms-2">Vehicle Violations</h2>
                    </div>
                        ...
                        <div class="table-responsive" style="height: 550px;">
                            <table id="vehicle-table" class="table table-bordered table-hover">
                                ...
                                <?php
                                    ...
                                    $result = $connection->query("SELECT vehicle_violations.*, vehicles.platenumber, 
            ...
            <!-- End of List of Vehicle Violations -->
        </div>
    ...
    <script>
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            if (IdToDelete) {
                $.ajax({
                    url: 'violationrecords_delete.php',
                    method: 'POST',
        ...
        //---------------------------Search Violation Record Results---------------------------//c
        function search() {
            const query = document.getElementById("searchInput").value;

            // Make an AJAX request to fetch search results
            $.ajax({
                url: 'violationrecords_search.php', // Replace with the actual URL to your search script
                method: 'POST',
                data: { query: query },
       ...
       //---------------------------Confirm Payment ---------------------------//
        ...
        document.getElementById('confirmButton').addEventListener('click', function () {
            if (IdToConfirm) {
                $.ajax({
                    url: "violationrecords_confirm.php",
                    method: "POST",
